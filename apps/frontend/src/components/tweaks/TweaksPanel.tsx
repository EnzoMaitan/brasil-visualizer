// Floating Tweaks shell + form-control helpers. Visual style preserved from the
// design prototype's omelette starter; behavior adapted to a controlled open/close
// model (App owns the open state; the gear button toggles it).
