...
**Municipality layer (optional, data-driven).** A topbar toggle overlays all 5,570
municipalities. Two lazy chunks load on first enable (initial load unaffected): the **mesh**
